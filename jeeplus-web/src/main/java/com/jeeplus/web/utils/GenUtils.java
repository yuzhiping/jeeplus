...
import com.jeeplus.web.entities.generate.ColumnEntity;
import com.jeeplus.web.entities.generate.TableEntity;
...
public class GenUtils {
    ...
    public static String getFileName(String template, String className, String packageName){
        ...
        if(template.contains("Entity.java.vm")){
            return packagePath + "entities" + File.separator + className + "Entity.java";
        }

        if(template.contains("Mapper.java.vm")){
            return packagePath + "mappper" + File.separator + className + "Mapper.java";
        }

        if(template.contains("Mapper.xml.vm")){
            return packagePath + "mappper" + File.separator + className + "Mapper.xml";
        }
