...
public class DataCubeAPI extends BaseAPI {
    ...
    public GetUserSummaryResponse getUserSummary(Date beginDate, Date endDate) {
        BeanUtils.requireNonNull(beginDate, "beginDate is null");
        BeanUtils.requireNonNull(endDate, "endDate is null");
        ...
        response = JSONUtils.toBean(resultJson, GetUserSummaryResponse.class);
        return response;
    }
    ...
    public GetUserCumulateResponse getUserCumulate(Date beginDate, Date endDate) {
        ...
        BaseResponse r = executePost(url, json);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtils.toBean(resultJson, GetUserCumulateResponse.class);
        return response;
    }
    ...
    public GetArticleSummaryResponse getArticleSummary(Date day) {
        BeanUtils.requireNonNull(day, "day is null");
        ...
        BaseResponse r = executePost(url, json);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtils.toBean(resultJson, GetArticleSummaryResponse.class);
        return response;
    }
    ...
    public GetArticleTotalResponse getArticleTotal(Date day) {
        ...
        BaseResponse r = executePost(url, json);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtils.toBean(resultJson, GetArticleTotalResponse.class);
        return response;
    }
    ...
    public GetUserReadResponse getUserRead(Date beginDate, Date endDate) {
        ...
        BaseResponse r = executePost(url, json);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtils.toBean(resultJson, GetUserReadResponse.class);
        return response;
    }
    ...
    public GetUserReadHourResponse getUserReadHour(Date day) {
        ...
        BaseResponse r = executePost(url, json);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtils.toBean(resultJson, GetUserReadHourResponse.class);
        return response;
    }
    ...
    public GetUserShareResponse getUserShare(Date beginDate, Date endDate) {
        ...
        BaseResponse r = executePost(url, json);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtils.toBean(resultJson, GetUserShareResponse.class);
        return response;
    }
    ...
    public GetUserShareHourResponse getUserShareHour(Date day) {
        ...
        BaseResponse r = executePost(url, json);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtils.toBean(resultJson, GetUserShareHourResponse.class);
        return response;
    }
    ...
    public GetUpstreamMsgResponse getUpstreamMsg(Date beginDate, Date endDate) {
        ...
        BaseResponse r = executePost(url, json);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtils.toBean(resultJson, GetUpstreamMsgResponse.class);
        return response;
    }
    ...
    public GetUpstreamMsgHourResponse getUpstreamMsgHour(Date day) {
        ...
        BaseResponse r = executePost(url, json);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtils.toBean(resultJson, GetUpstreamMsgHourResponse.class);
        return response;
    }
    ...
    public GetUpstreamMsgWeekResponse getUpstreamMsgWeek(Date beginDate, Date endDate) {
        ...
        BaseResponse r = executePost(url, json);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtils.toBean(resultJson, GetUpstreamMsgWeekResponse.class);
        return response;
    }
    ...
    public GetUpstreamMsgMonthResponse getUpstreamMsgMonth(Date beginDate, Date endDate) {
        ...
        BaseResponse r = executePost(url, json);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtils.toBean(resultJson, GetUpstreamMsgMonthResponse.class);
        return response;
    }
    ...
    public GetUpstreamMsgDistResponse getUpstreamMsgDist(Date beginDate, Date endDate) {
        ...
        BaseResponse r = executePost(url, json);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtils.toBean(resultJson, GetUpstreamMsgDistResponse.class);
        return response;
    }
    ...
    public GetUpstreamMsgDistWeekResponse getUpstreamMsgDistWeek(Date beginDate, Date endDate) {
        ...
        BaseResponse r = executePost(url, json);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtils.toBean(resultJson, GetUpstreamMsgDistWeekResponse.class);
        return response;
    }
    ...
    public GetUpstreamMsgDistMonthResponse getUpstreamMsgDistMonth(Date beginDate, Date endDate) {
        ...
        BaseResponse r = executePost(url, json);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtils.toBean(resultJson, GetUpstreamMsgDistMonthResponse.class);
        return response;
    }
    ...
    public GetInterfaceSummaryResponse getInterfaceSummary(Date beginDate, Date endDate) {
        ...
        BaseResponse r = executePost(url, json);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtils.toBean(resultJson, GetInterfaceSummaryResponse.class);
        return response;
    }
    ...
    public GetInterfaceSummaryHourResponse getInterfaceSummaryHour(Date day) {
        ...
        BaseResponse r = executePost(url, json);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtils.toBean(resultJson, GetInterfaceSummaryHourResponse.class);
        return response;
    }
}
